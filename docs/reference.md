...
Detailed reference for Pixel Hop Workflow. This document holds the full behavioural
contract: every lifecycle, workflow, rule, and gate. For a friendly overview, start with
