...
- Volatile file/test counts, temporary rollout progress, and task completion state
- Links to active spec locations when specs are routinely archived; prefer feature names or archive-safe references
...
- Remove demonstrably stale contradictions and repair broken references; additive does not mean preserving false information
