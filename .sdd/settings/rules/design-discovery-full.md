...
- **Use an internet research capability** to find current primary sources:
...
- **Open and inspect primary documentation** to analyze:
...
### Search Strategy
1. Start with official documentation, standards, platform policies, and first-party repositories.
2. Record version and access date for version-sensitive findings.
3. Use secondary sources only to discover risks or corroborate behavior.
4. Clearly label inference and unresolved uncertainty.
