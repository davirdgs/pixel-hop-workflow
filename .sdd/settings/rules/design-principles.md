...
- Use the strongest practical type system provided by the project language
- Define explicit public boundary types for parameters and returns
- Use discriminated unions for error handling
- Avoid unsafe dynamic types or casts (`any`, unchecked casts, untyped dictionaries) at domain and integration boundaries
...
### Shared Interfaces & UI Contracts
- Define a shared contract for recurring UI components only when it removes real duplication without hiding platform conventions.
- Hooks, protocols, interfaces, utilities, and integration adapters that introduce new boundaries should include signatures in the project's language or language-neutral schemas.
